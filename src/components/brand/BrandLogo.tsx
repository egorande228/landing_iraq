...
type BrandLogoSize = 'nav' | 'footer' | 'hero';
...
const widthBySize: Record<BrandLogoSize, string> = {
  nav: '124px',
  footer: '148px',
  hero: 'clamp(180px, 34vw, 260px)',
};

const frameWidthBySize: Record<BrandLogoSize, string> = {
  nav: '144px',
  footer: '168px',
  hero: 'calc(clamp(180px, 34vw, 260px) + 24px)',
};

const paddingXBySize: Record<BrandLogoSize, string> = {
  nav: '10px',
  footer: '12px',
  hero: '14px',
};

const paddingYBySize: Record<BrandLogoSize, string> = {
  nav: '8px',
  footer: '9px',
  hero: '12px',
};
...
export function BrandLogo({
  ...
  return (
    <span
      className={joinClasses('brand-logo brand-logo--flip', glow && 'brand-logo--glow', className)}
      style={
        {
          display: 'inline-flex',
